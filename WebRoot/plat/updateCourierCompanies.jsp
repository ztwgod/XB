            ...
            <div class="ucenter-info mt10">
                <div class="u-tab-wrap">
                    <ul class="u-tab clearfix">
                        <li class="current"><a>修改快递公司</a></li>
                    </ul>
                    <!-- /.u-tab -->
                </div>
                ...
                <div id="tab-box">
                    ...
                    <div class="demo">
						<ul class="clearfix">
							...
							<li class="current">修改快递公司<em></em><i></i></li>
						</ul>
					</div>        
                ...
                <form action="<%=path%>/plat/doModifyCourierCompany.do" method="post" onsubmit="return checkForm(this);">
					
					<fieldset>
						<legend>修改快递公司</legend>
					...
					<table cellpadding="2" class="newTab" cellspacing="1">
					  ...
					  <tr>
					    ...
					    <td>
					    	<input type="hidden" id="excoId" name="excoId" value="${ec.excoId }"/>
                        	<input type="text" maxlength="60" id="excoName" name="excoName" value="${ec.excoName }"/>
                        </td>
					  </tr>
					  ...
					  <tr>
					    ...
					    <td>
                        	<input type="text" maxlength="10" id="contactorName" name="contactorName" value="${ec.contactorName }"/>
                        </td>
					  </tr>
                      ...
                      <tr>
					    ...
					    <td>
                        		<input type="text" maxlength="15" id="contactPhone" name="contactPhone" value="${ec.contactPhone }" onblur="if(!x_checkTelephone(this.value)){show_err_msg('请输入合法联系电话');this.value='';}"/>
                        </td>
					  </tr>
                       ...
                       <tr>
					    ...
					    <td>
                        	<input type="text" id="contactAdd" maxlength="80" name="contactAdd" value="${ec.contactAdd }" style="width: 300px;"/>
                        </td>
					  </tr>
					    ...
					    <td>
                        	<select id="serviceStatus" name="serviceStatus" style="height: 25px; width: 125px;">
                        		<c:forEach items="${serviceStatusList}" var="ss">
                        			<option value="${ss.code}" <c:if test="${ss.code == ec.serviceStatus}">selected</c:if>>${ss.name}</option>
                        		</c:forEach>
                        	</select>
                        </td>
					  </tr>
                       ...
                       <tr>
					    ...
					    <td>
                        	<input type="text" id="validDate" name="validDate" value="<fmt:formatDate value="${ec.validDate }" pattern="yyyy-MM-dd"/>" onclick="new Calendar().show(this);" readonly="readonly"/>
                        </td>
					  </tr>
                       ...
                       <tr>
					    ...
					    <td>
                        	<input type="text" maxlength="30" onkeyup="x_NaNAndLetter(this)" onblur="x_NaNAndLetter(this)" id="contractNo" name="contractNo" value="${ec.contractNo }"/>
                        </td>
					  </tr>
                       ...
                       <tr>
					    ...
					    <td>
                        	<button id="do_search" class="search" type="button" onclick="history.go(-1);">返回</button>
