	                                ...
	                                <td align="left" style="text-align: left;">
	                                	...
	                                	<c:forEach items="${ow.tadws}" var="tadw">
	                                		...
	                                		<c:if test="${tadw.transActionType eq 1}">
	                                			客户<b title="联系方式: ${tadw.actionerMobileNum }"><u>${tadw.actionerMobileNum }<!-- ${tadw.actionerName } --></u></b>成功投入寄件快件
	                                		</c:if>
	                                		...
	                                		<c:if test="${tadw.transActionType eq 4}">
	                                			客户<b title="联系方式: ${tadw.actionerMobileNum }"><u>${tadw.actionerMobileNum }<!-- ${tadw.actionerName } --></u></b>已成功将快件取走
	                                		</c:if>
	                                		<c:if test="${tadw.transActionType eq 5}">
	                                			客户<b title="联系方式: ${tadw.actionerMobileNum }"><u>${tadw.actionerMobileNum }<!-- ${tadw.actionerName } --></u></b>成功寄存一个快件
	                                		</c:if>
	                                		<c:if test="${tadw.transActionType eq 6}">
	                                			客户<b title="联系方式: ${tadw.actionerMobileNum }"><u>${tadw.actionerMobileNum }<!-- ${tadw.actionerName } --></u></b>成功将寄存件取走
	                                		</c:if>
	                                		<c:if test="${tadw.transActionType eq 7}">
	                                			客户<b title="联系方式: ${tadw.actionerMobileNum }"><u>${tadw.actionerMobileNum }<!-- ${tadw.actionerName } --></u></b>想寄件，但无空箱
	                                		</c:if>
	                                		...
	                                		<c:if test="${tadw.transActionType eq 9}">
	                                			客户<b title="联系方式: ${tadw.actionerMobileNum }"><u>${tadw.actionerMobileNum }<!-- ${tadw.actionerName } --></u></b>想寄存，但无空箱
	                                		</c:if>
	                                		...
	                                		<c:if test="${tadw.transActionType eq 11}">
	                                			客户<b title="联系方式: ${tadw.actionerMobileNum }"><u>${tadw.actionerMobileNum }<!-- ${tadw.actionerName } --></u></b>的寄存件被退件
	                                		</c:if>
