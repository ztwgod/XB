...
<head>
    ...
    <script src="<%=path%>/js/plat/addCard.js" type="text/javascript"></script>
</head>
<body>
        <div class="u-main">
            <div class="ucenter-info mt10">
                ...
                <div class="demo">
						<ul class="clearfix">
							...
							<li class="current">绑定卡片<em></em><i></i></li>
						</ul>
					</div>
				...
				<fieldset>
              	...
              	<form action="<%=path%>/plat/doAddCard.do" id="frm" name="frm" method="post">
				...
				<table border="0" cellpadding="2" cellspacing="1" style="width:80%" align="center" class="newTab">
					    ...
					    <td>
                        	${card.userAccount}
                        	<input type="hidden" id="userId" name="userId" value="${card.userId}" />
                        </td>					  	
					  </tr>								  
					   <tr>
                        <td align="right"><font style="color: red;">*&nbsp;</font>有效期：</td>
					    <td>
					    	<input type="text" id="cardExpirationDate" name="cardExpirationDate" value="<fmt:formatDate value="${card.endTime}" pattern="yyyy-MM-dd"/>" style="border:1px solid #999;" onclick="new Calendar().show(this);" readonly="readonly" />                           
                        </td>
					  ...
					  <tr>
					   ...
					   <tr>
					    ...
					    <td>
                        	<input type="text" id="cardCode" name="cardCode"  maxlength="20" />
                        </td>					  	
					  </tr>
					   <tr>
					  	<td align="right"><font style="color: red;">*&nbsp;</font>卡片密码：</td>
					    <td>
                        	<input type="password" id="cardPassword" name="cardPassword" maxlength="20" />
                        </td>					  	
					  </tr>
					   ...
					   <tr>
					    ...
					    <td>
                        	<input type="password" id="scardPassword" name="scardPassword" maxlength="20" />
                        </td>					  	
					  </tr>
					    ...
					    <td>
                        	<select id="issuedAgency" name="issuedAgency" >
                        		...
                        		<c:forEach items="${issuredAgency}" var="s">
                        			<option value="${s.agencyId}">${s.agencyName}</option>
                        		</c:forEach>
                        	</select>                        	
                        </td>					  	
					  </tr>
